...
public class DefaultConfig implements Configuration {
	...
	private DefaultConfig() {
		...
		logger.info("-------reousrce path:" + this.getClass().getClassLoader().getResource(FILE_NAME).getPath());
	...
	public List<String> getExtDictionarys() {
		...
		if (extDictCfg != null) {
			logger.info("-----------raw dict" + extDictCfg);
			// 使用;分割多个扩展字典配置
			String[] filePaths = extDictCfg.split(";");
			if (filePaths != null) {
				for (String filePath : filePaths) {
					if (filePath != null && !"".equals(filePath.trim())) {
						logger.info("-----------add ext dict" + filePath);
	...
	public List<String> getExtStopWordDictionarys() {
		...
		logger.info("-----------raw stop" + extStopWordDictCfg);
		if (extStopWordDictCfg != null) {
			...
			if (filePaths != null) {
				for (String filePath : filePaths) {
					if (filePath != null && !"".equals(filePath.trim())) {
						logger.info("-----------add ext stop" + filePath);
